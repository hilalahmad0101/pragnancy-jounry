...
export default function Home() {
  ...
  const { userLogin, loading } = useContext(GlobalContext)
  ...
  return (
    <main className="w-full h-screen bg-gray-100 flex justify-center items-center">
      <div className="container max-w-md">
        <form className="shadow-md bg-white rounded-md px-[49px] py-[30px]" onSubmit={onSubmitData}>
          ...
          <div className="my-3">
            <button className="w-full py-3 text-center bg-pink-400 text-white rounded-[8px]">
              {loading ?
