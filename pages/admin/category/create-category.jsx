 ...
 const router= useRouter();
  ...
  const onSubmitHandle=async(e)=>{
    ...
    if(name && description){
      ...
      const res=await (await fetch(getCreateBlogCategoryUrl,{
        method:'POST',
    ...
    <div className="w-[90%] mx-auto py-10 ">
      ...
      <div>
        <div className="container max-w-3xl mx-auto my-10">
          <form onSubmit={onSubmitHandle} className="shadow-md bg-white rounded-md px-[49px] py-[30px]">
            ...
            <div className="my-3">
                <button type="submit" className="w-full py-3 text-center bg-pink-400 text-white rounded-[8px]">
                {
                  loading
