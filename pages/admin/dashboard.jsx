    ...
    <main className="flex">
      <div
        className={`w-[240px] lg:w-[300px] ${
          !sidebar ? "hidden" : ""
        } lg:block lg:sticky fixed bg-white h-screen `}
      >
        ...
        <h1 className="text-center pt-20 font-bold text-2xl">
      ...
      <div className="w-full">
        ...
        <div className="bg-gray-100 w-full h-screen py-10 px-10">
          ...
          <div className="my-1">
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-3">
              <div className="bg-yellow-400 flex justify-center flex-col items-center py-10 rounded-md">
                ...
                <h1 className="text-[20px] font-semibold text-white my-2">
                  Category
                </h1>
              </div>
              <div className="bg-yellow-400 flex justify-center flex-col items-center py-10 rounded-md">
